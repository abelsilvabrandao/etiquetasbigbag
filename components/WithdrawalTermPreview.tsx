...
const WithdrawalTermPreview: React.FC<WithdrawalTermPreviewProps> = ({ data }) => {
  return (
    <div className="bg-white text-black p-[1.5cm] w-[21cm] min-h-[29.7cm] flex flex-col font-sans text-sm leading-normal">
      ...
      <div className="mb-12 overflow-hidden border-2 border-[#00703C] rounded-lg">
      ...
      <div className="mb-12 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-y-8 gap-x-12 pl-4">
          <div className="flex items-end gap-3">
             <span className="font-bold text-[12px] uppercase whitespace-nowrap">Data da Retirada:</span>
             <div className="flex-1 border-b-2 border-black h-6 min-w-[150px]"></div>
          </div>
          <div className="flex items-end gap-3">
             <span className="font-bold text-[12px] uppercase whitespace-nowrap">Hora da Retirada:</span>
             <div className="flex-1 border-b-2 border-black h-6 min-w-[100px]"></div>
          </div>
          <div className="flex items-end gap-3">
             <span className="font-bold text-[12px] uppercase whitespace-nowrap">Qtd. Lacres:</span>
             <div className="flex-1 border-b-2 border-black h-6"></div>
          </div>
          <div className="flex items-end gap-3">
             <span className="font-bold text-[12px] uppercase whitespace-nowrap">Qtd. Etiquetas:</span>
             <div className="flex-1 border-b-2 border-black h-6"></div>
          </div>
        </div>
      </div>
      ...
      {/* Assinaturas (TEXTO ABAIXO DA LINHA) */}
      <div className="grid grid-cols-2 gap-16 mt-8">
        <div className="flex flex-col items-center">
            ...
            <span className="text-[9px] text-slate-400 font-bold">(Conforme documento de identidade)</span>
        </div>

        <div className="flex flex-col items-center">
            <div className="w-full border-b-2 border-black mb-2"></div>
            <span className="font-black text-[11px] uppercase tracking-tighter">Assinatura do Responsável (Gate)</span>
            <span className="text-[9px] text-slate-400 font-bold">Intermarítima Portos e Logística S/A</span>
        </div>
      </div>
      ...
      <div className="mt-auto pt-10">
          ...
          <div className="flex justify-between items-center">
            <div className="text-[10px] text-slate-500 font-bold uppercase leading-tight space-y-0.5">
                ...
                <p className="text-emerald-700 font-black mt-1">www.intermaritima.com.br</p>
            </div>
            ...
            <div className="flex items-center gap-6">
                ...
                <div className="flex flex-col items-center border-l-2 border-slate-100 pl-6">
                    <span className="text-[8px] text-slate-400 font-black">CERTIFICAÇÃO</span>
                    <span className="text-[14px] text-slate-800 font-black">ISO 9001</span>
                </div>
            </div>
          </div>
      </div>
